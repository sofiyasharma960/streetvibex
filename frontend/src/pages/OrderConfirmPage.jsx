...
export default function OrderConfirmPage({ setCart }) {
  ...
  const orderId = state?.orderId
    ? String(state.orderId).slice(-8).toUpperCase()
    : "—";
  ...
  return (
    <div className="min-h-screen bg-black text-white flex flex-col items-center justify-center px-6 relative overflow-hidden">
      <div className="absolute inset-0 pointer-events-none -z-10" style={{
        ...
        backgroundImage:
          "linear-gradient(to right, rgba(0,245,255,0.02) 1px, transparent 1px), linear-gradient(to bottom, rgba(0,245,255,0.02) 1px, transparent 1px)",
      }} />
      ...
      >
        ...
        <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 0.4 }}>
          ...
          <div className="bg-white/5 backdrop-blur-md border border-white/10 rounded-3xl p-8 mb-10 text-left relative overflow-hidden">
            <div className="absolute top-0 left-0 w-full h-[2px] bg-gradient-to-r from-transparent via-[#00FFFF]/40 to-transparent" />
            {[
              ...
              { label: "ORDER ID", value: `#SVX-${orderId}`,   color: "text-white/30" }, // ← real ID
            ].map((item, i) => (
          ...
          <div className="flex flex-col gap-4">
            ...
            <button
              ...
              className="text-[9px] tracking-widest text-white/30 hover:text-[#00FFFF] transition-colors uppercase"
            >
              View my orders →
            </button>
